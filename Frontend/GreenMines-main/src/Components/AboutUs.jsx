      ...
      <div className="space-y-8 w-full max-w-3xl">
        ...
        <div className={sectionStyle}>
          ...
          <p className={textStyle}>
            At GREENMINES, our mission is to combat climate change by providing innovative solutions for quantifying and reducing carbon emissions. We aim to support industries and organizations in their journey towards carbon neutrality through accurate measurements, actionable insights, and effective strategies.
          </p>
        </div>
